...
<?php include "includes/sidenav.php";?>
    ...
    <h1 class="display-2 pashtofont text-center"> د دوکان دایمی سامان کهاته </h1>
		<div class="row">
...
<?php
$query = "SELECT SUM(Iprice_af) as RtotalAF,SUM(Iprice_rs) as RtotalRS,SUM(Iprice_dollar) as RtotalDollar,SUM(Oprice_af) as TtotalAF,SUM(Oprice_rs) as TtotalRS,SUM(Oprice_dollar) as TtotalDollar FROM income WHERE income_category = 'دوکان دایمی سامان'";
...
?>
 ...
 <div class="table-responsive mt-5">
              <table class="table align-items-center table-flush table-condensed table-bordered table-striped table-primary" id="">
...
<?php
$query = "SELECT * FROM income WHERE income_category = 'دوکان دایمی سامان' ORDER BY income_id DESC";

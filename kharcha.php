...
<?php include "includes/sidenav.php";?>
    ...
    <h1 class="display-2 pashtofont text-center"> د دوکان خرچی کهاته</h1>
		<div class="row">
...
<?php
$query = "SELECT SUM(Iprice_af) as RtotalAF,SUM(Iprice_rs) as RtotalRS,SUM(Iprice_dollar) as RtotalDollar,SUM(Oprice_af) as TtotalAF,SUM(Oprice_rs) as TtotalRS,SUM(Oprice_dollar) as TtotalDollar FROM income WHERE DATE(income_date) > '2020-09-26' AND income_category = 'خرچه'";
...
<?php
$query = "SELECT * FROM income WHERE DATE(income_date) > '2020-09-26' AND income_category = 'خرچه' order by income_id DESC";

...
<?php include "includes/sidenav.php";?>
    ...
    <h1 class="display-2 pashtofont text-center">  ټول خرڅ شوی سامان حساب</h1>
		<div class="row">
...
<?php
$query = "SELECT SUM(Iprice_af) as RtotalAF,SUM(Iprice_rs) as RtotalRS,SUM(Iprice_dollar) as RtotalDollar,SUM(Oprice_af) as TtotalAF,SUM(Oprice_rs) as TtotalRS,SUM(Oprice_dollar) as TtotalDollar FROM income WHERE DATE(income_date) > '2020-09-26' AND  income_des = 'خرڅ شوی سامان'";
...
?>
 ...
 <div class="table-responsive mt-5">
              <table class="table align-items-center table-flush table-bordered table-striped table-primary" id="search">
...
<?php
$query = "SELECT * FROM income WHERE DATE(income_date) > '2020-09-26' AND income_des = 'خرڅ شوی سامان'";

...
<?php include "includes/sidenav.php";?>
    ...
    <h1 class="display-2 pashtofont text-center"> صرافی کهاته</h1>
		<div class="row">
...
<?php
$query = "SELECT SUM(Iprice_af) as RtotalAF,SUM(Iprice_rs) as RtotalRS,SUM(Iprice_dollar) as RtotalDollar,SUM(Oprice_af) as TtotalAF,SUM(Oprice_rs) as TtotalRS,SUM(Oprice_dollar) as TtotalDollar FROM income WHERE income_category = 'صرافی'";
...
<?php
$query = "SELECT * FROM income WHERE income_category = 'صرافی' ORDER BY income_id DESC";

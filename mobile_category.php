...
?>
    ...
    <h1 class="display-2 pashtofont text-center">Mobile Category</h1>
		<div class="row">
...
<?php
    ...
    <form action="" method="POST">
    <div class="input-group mb-3">
      <input name="cat" type="text" class="form-control" placeholder="موبایل کټګوری" aria-label="Recipient's username" aria-describedby="basic-addon2">
      <div class="input-group-append">
